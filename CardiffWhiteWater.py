...
def ciww1(PixelsY=200, mode=1):
    Aspect_Ratio_Pixels=530.0/400.0
    Master_Speed=100.0
    Pixels_X,Velocity_Y,Velocity_X,Foam,Last_Radius_Scale_Factor,Detail_Modifiers=FlowGenerator.declarations(PixelsY,Aspect_Ratio_Pixels)
    ...
    Last_Curve_Properties=FlowGenerator.Generate(Aspect_Ratio_Pixels,PixelsY,Flow_Clockwise,Curve_Centre_X,Curve_Centre_Y,Angle_Start_Curve1,Angle_End_Curve1,Radius_Curve1,Thickness_Curve1,Width_Growth_Curve1,Aspect_Ratio_Curve1,Anlge_End_Curve_Next,Radius_Curve_Next,Width_Growth_Curve_Next,Aspect_Ratio_Curve_Next,Last_Radius_Scale_Factor,Detail_Modifiers,Master_Speed,Velocity_X,Velocity_Y,Foam)

    #CURVE 3
    Curve_Centre_X, Curve_Centre_Y, Angle_Start_Curve1, Angle_End_Curve1, Radius_Curve1, Width_Growth_Curve1, Aspect_Ratio_Curve1, Last_Radius_Scale_Factor = Last_Curve_Properties
    ...
    Aspect_Ratio_Curve_Next=1.0/1.0
    Detail_Modifiers=[0.75,0.07,0.1,0.04,60,1]
    Detail_Modifiers.extend([0.85,0.22,0.1,0.055,60,2])
    Last_Curve_Properties=FlowGenerator.Generate(Aspect_Ratio_Pixels,PixelsY,Flow_Clockwise,Curve_Centre_X,Curve_Centre_Y,Angle_Start_Curve1,Angle_End_Curve1,Radius_Curve1,Thickness_Curve1,Width_Growth_Curve1,Aspect_Ratio_Curve1,Anlge_End_Curve_Next,Radius_Curve_Next,Width_Growth_Curve_Next,Aspect_Ratio_Curve_Next,Last_Radius_Scale_Factor,Detail_Modifiers,Master_Speed,Velocity_X,Velocity_Y,Foam)
    FlowGenerator.SaveResult(PixelsY,Pixels_X,Velocity_X,Velocity_Y,Foam,inspect.stack()[0][3],mode)
...
def ciww2(PixelsY=200):
    ...
    Aspect_Ratio_Curve_Next=1.0/1.0
    Detail_Modifiers=[0.62,0.65,0.3,0.09,70,4]
    Detail_Modifiers.extend([0.8,0.56,0.1,0.03,60,2])
    Detail_Modifiers.extend([0.47,0.34,0.285,0.08,70.9,3])
    Detail_Modifiers.extend([0.67,0.3,0.1,0.04,60,1])
    Detail_Modifiers.extend([0.32,0.55,0.2,0.2,45,7])
    Last_Curve_Properties=FlowGenerator.Generate(Aspect_Ratio_Pixels,PixelsY,Flow_Clockwise,Curve_Centre_X,Curve_Centre_Y,Angle_Start_Curve1,Angle_End_Curve1,Radius_Curve1,Thickness_Curve1,Width_Growth_Curve1,Aspect_Ratio_Curve1,Anlge_End_Curve_Next,Radius_Curve_Next,Width_Growth_Curve_Next,Aspect_Ratio_Curve_Next,Last_Radius_Scale_Factor,Detail_Modifiers,Master_Speed,Velocity_X,Velocity_Y,Foam)
...
def ciww3(PixelsY=200):
    ...
    Width_Growth_Curve_Next=-0.0
    Aspect_Ratio_Curve_Next=1.0/1.0
    Detail_Modifiers=[0.22,0.55,0.198,0.09,75,3]
    Detail_Modifiers.extend([0.365,0.77,0.26,0.07,75,4])
    Detail_Modifiers.extend([0.88,0.52,0.085,0.15,85,4])
    Detail_Modifiers.extend([0.69,0.59,0.12,0.04,60,4])
    Detail_Modifiers.extend([0.65,0.38,0.26,0.06,61,3])
    Detail_Modifiers.extend([0.57,0.67,0.03,0.01,63,2])
    Detail_Modifiers.extend([0.1,0.7,0.15,0.15,60,7])
    Last_Curve_Properties=FlowGenerator.Generate(Aspect_Ratio_Pixels,PixelsY,Flow_Clockwise,Curve_Centre_X,Curve_Centre_Y,Angle_Start_Curve1,Angle_End_Curve1,Radius_Curve1,Thickness_Curve1,Width_Growth_Curve1,Aspect_Ratio_Curve1,Anlge_End_Curve_Next,Radius_Curve_Next,Width_Growth_Curve_Next,Aspect_Ratio_Curve_Next,Last_Radius_Scale_Factor,Detail_Modifiers,Master_Speed,Velocity_X,Velocity_Y,Foam)
    FlowGenerator.SaveResult(PixelsY,Pixels_X,Velocity_X,Velocity_Y,Foam,inspect.stack()[0][3])
...
def ciww4(PixelsY=200):
    ...
    Width_Growth_Curve_Next=-0.0
    Aspect_Ratio_Curve_Next=1.0/1.0
    Detail_Modifiers=[0.77,0.27,0.1,0.03,-15,2]
    Detail_Modifiers.extend([0.7,0.17,0.02,0.01,-15,2])
    Detail_Modifiers.extend([0.01,-0.09,20,7.5,145.25,5])
    Detail_Modifiers.extend([0.06,0.26,47,9,132.110,6])
    Detail_Modifiers.extend([0.47,0.24,0.02,0.02,-95,2])
    Last_Curve_Properties=FlowGenerator.Generate(Aspect_Ratio_Pixels,PixelsY,Flow_Clockwise,Curve_Centre_X,Curve_Centre_Y,Angle_Start_Curve1,Angle_End_Curve1,Radius_Curve1,Thickness_Curve1,Width_Growth_Curve1,Aspect_Ratio_Curve1,Anlge_End_Curve_Next,Radius_Curve_Next,Width_Growth_Curve_Next,Aspect_Ratio_Curve_Next,Last_Radius_Scale_Factor,Detail_Modifiers,Master_Speed,Velocity_X,Velocity_Y,Foam)
    FlowGenerator.SaveResult(PixelsY,Pixels_X,Velocity_X,Velocity_Y,Foam,inspect.stack()[0][3])
...
def ciww5(PixelsY=200):
    ...
    Width_Growth_Curve_Next=0.0
    Aspect_Ratio_Curve_Next=1.0/1.0
    Detail_Modifiers=[0.25,0.55,0.1,0.04,-110,1]
    Detail_Modifiers.extend([0.08,0.25,0.1,0.06,-110,2])
    Detail_Modifiers.extend([0.83,0.62,0.22,0.12,-20,4])
    Detail_Modifiers.extend([0.35,0.89,60,9,28.100,6])
    Last_Curve_Properties=FlowGenerator.Generate(Aspect_Ratio_Pixels,PixelsY,Flow_Clockwise,Curve_Centre_X,Curve_Centre_Y,Angle_Start_Curve1,Angle_End_Curve1,Radius_Curve1,Thickness_Curve1,Width_Growth_Curve1,Aspect_Ratio_Curve1,Anlge_End_Curve_Next,Radius_Curve_Next,Width_Growth_Curve_Next,Aspect_Ratio_Curve_Next,Last_Radius_Scale_Factor,Detail_Modifiers,Master_Speed,Velocity_X,Velocity_Y,Foam)
    FlowGenerator.SaveResult(PixelsY,Pixels_X,Velocity_X,Velocity_Y,Foam,inspect.stack()[0][3])
...
def ciww6(PixelsY=200):
    ...
    Width_Growth_Curve_Next=0.0
    Aspect_Ratio_Curve_Next=1.0/1.0
    Detail_Modifiers=[0.64,0.19,0.21,0.06,-110,4]
    Detail_Modifiers.extend([0.27,0.41,0.21,0.035,-115,4])
    Detail_Modifiers.extend([0.75,0.4,0.21,0.05,-130,3])
    Detail_Modifiers.extend([0.35,0.62,0.24,0.065,-110,3])
    Last_Curve_Properties=FlowGenerator.Generate(Aspect_Ratio_Pixels,PixelsY,Flow_Clockwise,Curve_Centre_X,Curve_Centre_Y,Angle_Start_Curve1,Angle_End_Curve1,Radius_Curve1,Thickness_Curve1,Width_Growth_Curve1,Aspect_Ratio_Curve1,Anlge_End_Curve_Next,Radius_Curve_Next,Width_Growth_Curve_Next,Aspect_Ratio_Curve_Next,Last_Radius_Scale_Factor,Detail_Modifiers,Master_Speed,Velocity_X,Velocity_Y,Foam)
    FlowGenerator.SaveResult(PixelsY,Pixels_X,Velocity_X,Velocity_Y,Foam,inspect.stack()[0][3])
...
def ciww7(PixelsY=200):
    ...
    Width_Growth_Curve_Next=0.0
    Aspect_Ratio_Curve_Next=1.0/1.0
    Detail_Modifiers=[0.58,0.635,0.35,0.075,-117,3]
    Detail_Modifiers.extend([0.44,0.77,0.2,0.04,-110,1])
    Detail_Modifiers.extend([0.57,0.41,0.37,0.075,-117,4])
    Last_Curve_Properties=FlowGenerator.Generate(Aspect_Ratio_Pixels,PixelsY,Flow_Clockwise,Curve_Centre_X,Curve_Centre_Y,Angle_Start_Curve1,Angle_End_Curve1,Radius_Curve1,Thickness_Curve1,Width_Growth_Curve1,Aspect_Ratio_Curve1,Anlge_End_Curve_Next,Radius_Curve_Next,Width_Growth_Curve_Next,Aspect_Ratio_Curve_Next,Last_Radius_Scale_Factor,Detail_Modifiers,Master_Speed,Velocity_X,Velocity_Y,Foam)
    FlowGenerator.SaveResult(PixelsY,Pixels_X,Velocity_X,Velocity_Y,Foam,inspect.stack()[0][3])
...
def ciww8(PixelsY=200):
    ...
    Width_Growth_Curve_Next=0.0
    Aspect_Ratio_Curve_Next=1.0/1.0
    Detail_Modifiers=[0.46,0.37,0.37,0.138,-100,4]
    Detail_Modifiers.extend([0.24,0.36,0.2,0.06,-110,2])
    Detail_Modifiers.extend([0.51,0.62,0.37,0.09,-107,3])
    Detail_Modifiers.extend([0.25,0.7,0.03,0.02,-100,1])
    Last_Curve_Properties=FlowGenerator.Generate(Aspect_Ratio_Pixels,PixelsY,Flow_Clockwise,Curve_Centre_X,Curve_Centre_Y,Angle_Start_Curve1,Angle_End_Curve1,Radius_Curve1,Thickness_Curve1,Width_Growth_Curve1,Aspect_Ratio_Curve1,Anlge_End_Curve_Next,Radius_Curve_Next,Width_Growth_Curve_Next,Aspect_Ratio_Curve_Next,Last_Radius_Scale_Factor,Detail_Modifiers,Master_Speed,Velocity_X,Velocity_Y,Foam)
    FlowGenerator.SaveResult(PixelsY,Pixels_X,Velocity_X,Velocity_Y,Foam,inspect.stack()[0][3])
...
def ciww9(PixelsY=200):
    ...
    Width_Growth_Curve_Next=0.0
    Aspect_Ratio_Curve_Next=1.0/1.0
    Detail_Modifiers=[0.69,0.45,0.2,0.05,-114,3]
    Detail_Modifiers.extend([0.56,0.53,0.05,0.025,-112,1])
    Detail_Modifiers.extend([0.62,0.24,0.21,0.05,-114,4])
    Last_Curve_Properties=FlowGenerator.Generate(Aspect_Ratio_Pixels,PixelsY,Flow_Clockwise,Curve_Centre_X,Curve_Centre_Y,Angle_Start_Curve1,Angle_End_Curve1,Radius_Curve1,Thickness_Curve1,Width_Growth_Curve1,Aspect_Ratio_Curve1,Anlge_End_Curve_Next,Radius_Curve_Next,Width_Growth_Curve_Next,Aspect_Ratio_Curve_Next,Last_Radius_Scale_Factor,Detail_Modifiers,Master_Speed,Velocity_X,Velocity_Y,Foam)
    FlowGenerator.SaveResult(PixelsY,Pixels_X,Velocity_X,Velocity_Y,Foam,inspect.stack()[0][3])
